...
DESCRIPTION: This is the default module executed when no particular parser mod is passed to cybernethunter.py.
...
class ParserMod():
    ...
    # a generator back to the calling module (like cybernethunter.py) so that records can be iterated through.
    def execute(self):
